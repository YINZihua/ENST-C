...
int main(int argc, char *argv[])
{
  ...
  char * game_of_thrones_names[15] = {GoT_str1,   GoT_str2,   GoT_str3,
                                      GoT_str4,   GoT_str2,   GoT_str5,
                                      GoT_str6,   GoT_str7,   GoT_str8,
                                      GoT_str9,   GoT_str10,  GoT_str11,
                                      GoT_str12,  GoT_str13,  GoT_str8};
...
void sort_string_array(char ** tab, int nb_of_elements)
{
  ...
  for(i = 1; i < nb_of_elements; i++)
    for(j = i; (j > 0) && ((my_strcmp(*(tab+j), *(tab+j-1))) == -1); j--)
      swap(&(*(tab+j)), &(*(tab+j-1)));
}

void swap(char** str1, char** str2)
{ char* idm = *str1; *str1 = *str2;  *str2 = idm;}
